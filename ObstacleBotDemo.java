...
public class ObstacleBotDemo
{
   ...
   {
      Display.openWorld("maps/obstacle2.map");  //DON'T FORGET to test on obstacle2.map as well!
      ...
      */
      ...
      /*
      CountBot example2 = new CountBot(4, 7); //Modify column and goal height!
      example2.run();*/
      ...
      for (int i = 0; i < 10; i++)
      {
         cthreads[i] = new Thread(new CountBot(i+1, i+1));
      }
      for (int i = 0; i < 10; i++)
      {
         cthreads[i].start();
